...
bool j1App::Update()
{
	BROFILER_CATEGORY("Update", Profiler::Color::DarkBlue);
	bool ret = true;
	PrepareUpdate();
...
{
	BROFILER_CATEGORY("PrepareUpdate", Profiler::Color::CornflowerBlue);
	frame_count++;
...
{
	BROFILER_CATEGORY("FinishUpdate", Profiler::Color::DodgerBlue);
...
{
	BROFILER_CATEGORY("PreUpdate", Profiler::Color::DeepSkyBlue);
	bool ret = true;
	p2List_item<j1Module*>* item;
	item = modules.start;
...
{
	BROFILER_CATEGORY("PostUpdate", Profiler::Color::MediumTurquoise);
	bool ret = true;
	p2List_item<j1Module*>* item;
	j1Module* pModule = NULL;
